"""
growatt_storage_sph_holding.py

Modbus Holding Register Map for Growatt Storage (SPH Type) Inverters.
Based on Protocol V1.24 - HOLDING REGISTERS (Function Code 03).

Covered Ranges:
- 0-124: Basic System Settings
- 1000-1124: Storage Strategy, Battery Limits & Time-of-Use
...
REG_HOLDING_SPH_H_BAT_MAP = {
    ...
    # 1014: AC Charge (Charging from Grid) Enable
    ...
    "ACCharge_SlotEnable": (19, 1, 1, "uint"),
